...
CREATE TABLE "stories" (
	...
	"mood" text,
	"complexity" text,
	"literary_sophistication" integer,
...
ALTER TABLE "story_reactions" ADD CONSTRAINT "story_reactions_user_id_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;