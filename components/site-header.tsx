...
const navLinkClass =
  "rounded-md px-2 py-1 transition hover:bg-elevated hover:text-accent active:bg-elevated/80 active:opacity-90";
...
export async function SiteHeader() {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-border-subtle bg-surface/95 pt-[max(0.5rem,env(safe-area-inset-top))] backdrop-blur-md">
      <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-x-4 gap-y-2 px-3 py-2.5 sm:px-4 md:px-5">
        <div className="flex min-w-0 flex-1 items-center gap-3 sm:gap-6">
          <Link href="/" className="group shrink-0 leading-tight">
            ...
            <p className="text-sm font-semibold tracking-tight text-text-primary transition-colors group-hover:text-accent group-active:opacity-90">
              Audiobooks
            </p>
          </Link>
          <nav
