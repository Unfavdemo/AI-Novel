...
export function EditorPanel({ value, onChange }: EditorPanelProps) {
  return (
    <section className="flex min-h-0 flex-1 flex-col rounded-xl border border-border-subtle bg-elevated/40">
      <header className="flex items-center justify-between gap-3 border-b border-border-subtle px-5 py-3">
        ...
        <span className="rounded-full border border-border-subtle bg-elevated-2 px-3 py-1 text-[11px] tabular-nums text-text-muted">
      ...
      <div className="relative min-h-[12rem] flex-1 p-4 md:p-6">
        ...
        <textarea
          className="manuscript-editor relative z-[1] h-full min-h-[18rem] w-full resize-none rounded-lg border border-border-subtle bg-surface px-5 py-4 font-serif text-[15px] leading-relaxed text-text-primary outline-none ring-gold-500/30 focus:border-gold-500/40 focus:ring-2 md:min-h-[20rem] md:text-[16px] md:leading-8"
          spellCheck={false}
